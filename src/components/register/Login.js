...
function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    fetch("http://globlix.com/admin/api/vendor/login", {
      method: "POST",
      headers: {
    ...
    fetch("http://globlix.com/admin/api/vendor/register", {
      ...
      .then((result) => {
        if (result.message == "Vendor successfully registered") {
          alert('you have successfully rfegistered please login')
        } else {
    ...
    <>
              ...
              <div className="card tab2-card">
                <div className="card-body">
                  ...
                  >
                    ...
                    textAlign : 'center',
                    color : '#000'
                  }}>Are you a User ? <Link to='/user-login'> LogIn Here</Link></p>
                    ...
                    textAlign : 'center',
                    color : '#000'
                  }}>Are you a User ? <Link to='/user-login'> Register Here</Link></p>
                    ...
                    >
                      ...
                      {countries.map((country) => (
                        ...
                        <div className="form-button">
                          <button className="btn btn-primary" onClick={handleSubmitRegoister}> Submit</button>
                        </div>
                        <div className="form-footer">
                          <div className="social-icons social-icon-border-color d-flex justify-content-center">
                            <a
      ...
      {/* <div className="page-content">
            <div className="container">
              ...
              />
                    <h3 style={{ textAlign :'center', marginTop:'20px', marginBottom:'20px'}}>Sign In</h3>
                    <p style={{
                    textAlign : 'center'
                  }}>Are you a User ? <Link to='/user-login'> LogIn Here</Link></p>
